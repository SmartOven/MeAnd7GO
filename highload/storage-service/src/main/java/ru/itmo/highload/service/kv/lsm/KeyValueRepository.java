...
import ru.itmo.highload.service.kv.lsm.storage.MemTableWal;
...
public class KeyValueRepository {
    ...
    public void logStoragePath() {
        log.info("LSM-repository is running in {} directory", ssTablesDirPath.getParent().toRealPath());
    }

    @PreDestroy
    public void logDestroy() {
        log.info("LSM-repository is destroyed, memory usage = {}", getMemUsage());
    }
    ...
    public MemTableVersioned getMemTableVersionedWal() {
        return new MemTableVersioned(memTableWal.loadFromFile(), memTableWal.getLastModified());
    }

    public void addWalMemTable(MemTable walMemTable) {
        memTable.putAll(walMemTable);
    }
